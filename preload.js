...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  uploadSshSessionFiles: (sessionId, localPaths) => ipcRenderer.invoke('upload-ssh-session-files', sessionId, localPaths),
  listSshSessionFiles: (sessionId, remoteDirectory) => ipcRenderer.invoke('list-ssh-session-files', sessionId, remoteDirectory),
  downloadSshSessionFile: (sessionId, remotePath) => ipcRenderer.invoke('download-ssh-session-file', sessionId, remotePath),
